...
6. Reparse and scan output, inspect representative changes and test seeded synthetic identifiers. A second pass with the same blind spots is not independent proof.
